...
const resumeLink = "https://drive.google.com/uc?export=download&id=1U9hYCyJpKZYXLHBcYvO81gh5JcAc8mUD"; // Replace with your actual file ID
const email = "dhruvin1309@gmail.com";
const emailSubject = encodeURIComponent("Inquiry from your portfolio");
const emailBody = encodeURIComponent("Hi Dhruvin,\n\nI saw your portfolio and would like to get in touch.\n\nThanks!");
const githubUrl = "https://github.com/dhruvinhet";
const linkedinUrl = "https://www.linkedin.com/in/pateldhruvinkumar/";
...
const Main = () => {
  ...
  const experiences = [
    {
      ...
      description: 'RAG-based AI System for document querying and analysis.'
    },
    {
      role: 'AI/ML Engineer Intern',
      company: 'Ahir Infotech',
      period: 'April 2025 to June 2025',
      description: 'Built Healthcare Chatbot Model Development.'
    }
  ];
            ...
            <Card className="bg-gradient-to-br from-blue-500 to-purple-600 text-white border-0">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span>dhruvin1309@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
  ...
  <Button
    variant="ghost"
    size="icon"
    className="rounded-full bg-gray-800 dark:bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700 text-gray-300 hover:text-white"
    onClick={() => window.open(githubUrl, "_blank")}
  >
    <Github className="w-4 h-4" />
  </Button>
